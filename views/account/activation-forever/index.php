...
// \yii\helpers\VarDumper::dump(Yii::$app->params['api'], 5, true);die;
?>
...
//            Yii::$app->cache->flush();
            ...
            <div class="site-signup">
                <p><?=
                    $clone ?
                        Yii::t('account', 'Amount required for buy clone<b>{amount}</b>.', ['amount' => Api::asNumber($amount = Yii::$app->settings->get('system', 'promotionAmountForever1'))]) :
                        Yii::t('account', 'Amount required for activation <b>{amount}</b>.', ['amount' => Api::asNumber($amount = Yii::$app->settings->get('system', 'activationAmountForever'))])
                    ?>
                    <?php
